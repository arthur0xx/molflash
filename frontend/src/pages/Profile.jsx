        ...
        {tab === 'overview' && (
          <div className="overview-grid">
            ...
            <div className="ov-card" onClick={() => setTab('wallet')}>
              <b>{user.balance}</b><span>رصيدي (د.م.)</span>
            </div>
        ...
        {tab === 'wallet' && (
          <div className="wallet-layout">
            <div className="wallet-recharge">
              <div className="balance-hero">💳 {user.balance} <small>د.م.</small></div>
              ...
              <input className="input" type="number" placeholder="المبلغ بالدرهم المغربي (د.م.)" value={amount} onChange={e => setAmount(e.target.value)} />
