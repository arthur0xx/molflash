...
export function AdminConsole() {
  ...
  const navItems: [Tab, string][] = isManager
    ...
    : [["overview", "اليوم"], ["orders", "الطلبات"], ["products", "المنتجات"], ["categories", "التصنيفات"], ["customers", "العملاء"], ["support", "الدعم"], ["team", "الفريق"], ["payments", "إدارة الدفع"], ["settings", "الإعدادات"]];
