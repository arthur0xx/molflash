...
export function PhoneVerificationConsole() {
  ...
  async function sendCode() {
    ...
    setBusy(false);
    if (!result.ok) { setMessage(result.message || "تعذر إرسال الرمز."); return; }
