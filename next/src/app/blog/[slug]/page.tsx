    ...
    "@graph": [
      {
        ...
        inLanguage: "ar-MA",
        author: { "@type": "Organization", name: "ChriGsm", url: siteUrl },
        publisher: { "@type": "Organization", name: "ChriGsm", url: siteUrl, logo: { "@type": "ImageObject", url: `${siteUrl}/brand/cg-logo.png` } },
