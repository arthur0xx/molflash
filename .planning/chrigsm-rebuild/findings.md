...
- عُرضت نافذة **الحذف المتسلسل** عند اختيار حذف تصنيف، وتطلبت كتابة اسم التصنيف قبل تفعيل التأكيد. أُغلقت بالمسار الآمن «إلغاء» من دون حذف بيانات تجريبية. نجح أيضًا بناء Webpack كاملاً بعد إضافة المكوّن التفاعلي.
